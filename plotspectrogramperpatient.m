function [] = plotspectrogramperpatient(patientlist,conditionslist, rois )
...
a = 1;b = a + 2000; %the BL is 2 seconds
...
set(gca,'clim',[min(eegpower(:))  max(eegpower(:))],'xlim', [EEG.times(1) EEG.times(end)],'yscale','log','ytick',logspace(log10(min_freq),log10(max_freq),6),'yticklabel',round(logspace(log10(min_freq),log10(max_freq),6)*10)/10);
